...
```{r plot_country, echo= TRUE, fig.width=10, fig.height=11}
...
ORCID: [0000-0002-2719-9246](https://orcid.org/0000-0002-2719-9246)
...
This data will be read into RStudio, using the `tidyverse` package @R-tidyverse to filter it for those journals awarded the DOAJ Seal, and to remove unneeded columns containing the web addresses for journal policies around plagiarism, submission fees, and other urls not related to this study.
...
*This data table was compiled using the @R-DT*
...
This is auto-populated from your ORCID profile using the  `rorcid` package @R-rorcid. 

[0000-0002-2719-9246](https://orcid.org/0000-0002-2719-9246)
